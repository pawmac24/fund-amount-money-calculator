...
public class AggressiveFundCalculateServiceImpl extends FundCalculateServiceAbstract {
	...
	@Override public List<FundAmountOfMoneyDivision> divideAmountOfMoney(BigDecimal investmentMoney, List<InvestmentFund> investmentFunds) {
		List<FundAmountOfMoneyDivision> fundAmountOfMoneyDivisionList = new ArrayList<>();
		InvestmentProfile investmentProfile = new AggressiveInvestmentProfile();
