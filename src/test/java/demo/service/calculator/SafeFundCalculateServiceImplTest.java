...
public class SafeFundCalculateServiceImplTest {
    ...
    @Test
    public void testCalculateFundDivision01() {
    ...
    public void testCalculateFundDivision02() {
        ...
        assertEquals("MONEY FUND 1", fundDivisions.get(5).getFundName());
        assertEquals(new BigDecimal(666.67).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(0).getDividedMoney());
        assertEquals(new BigDecimal(666.67).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(1).getDividedMoney());
        assertEquals(new BigDecimal(666.67).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(2).getDividedMoney());
        assertEquals(new BigDecimal(3750.00).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(3).getDividedMoney());
        assertEquals(new BigDecimal(3750.00).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(4).getDividedMoney());
        assertEquals(new BigDecimal(500.00).setScale(2, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(5).getDividedMoney());
        assertEquals(new BigDecimal(0.0667).setScale(4, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(0).getDividedPercent());
        assertEquals(new BigDecimal(0.0667).setScale(4, BigDecimal.ROUND_HALF_DOWN), fundDivisions.get(1).getDividedPercent());
